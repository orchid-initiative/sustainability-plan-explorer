...
icon: "tree"
color: "#3F8A4E"
summary: "Creating more parks, tree canopy coverage, and green infrastructure that provides shade, improves air quality, and offers places for recreation and community gathering."
order: 1
...
goals:
  - id: "GS-S1"
    ...
    actions:
      ...
      - id: "GS-1b"
        text: "Increase planting of native, drought-tolerant, low-maintenance tree species with low fire risk."
      - id: "GS-1c"
        text: "Explore micro forest locations, especially in disadvantaged areas and priority park zone."
      - id: "GS-1d"
        text: "Establish a Street Tree Planting Program allowing residents to request trees in the public right-of-way."
      - id: "GS-1e"
        text: "Expand tree canopy in existing parks and along active transportation corridor."
      - id: "GS-1f"
        text: "Explore incentive programs (e.g., rebates, education) for commercial, residential, school site, and nonprofit planting."
      - id: "GS-1g"
        text: "Increase education for City staff and property owners on tree planting and care."
      - id: "GS-1h"
        text: "Encourage removal of hardscape and replacement with trees and green space."
      - id: "GS-1i"
  ...
  - id: "GS-S2"
    ...
    actions:
      ...
      - id: "GS-2b"
        text: "Prioritize park development in disadvantaged communities and areas with low access."
      - id: "GS-2c"
        text: "Add cooling amenities including shade trees, structures, water features, and recreational activities in heat-prone areas, with a focus on youth and seniors."
      - id: "GS-2d"
        text: "Develop partnerships to transform underutilized spaces into green areas, including converting Moor Field to a public park and collaborating with schools to transform blacktops through joint-use agreements."
      - id: "GS-2e"
  ...
  - id: "GS-S3"
    ...
    actions:
      ...
      - id: "GS-3b"
        text: "Strengthen landscaping standards in city code (e.g., ban artificial turf, require drought-tolerant species)."
      - id: "GS-3c"
        text: "Amend Tree Preservation Ordinance to restrict non-native species like palm trees."
      - id: "GS-3d"
        text: "Install demonstration gardens on City facilities to promote native, drought-tolerant species."
      - id: "GS-3e"
