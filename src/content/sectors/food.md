...
icon: "sprout"
color: "#C68A3A"
summary: "Supporting community gardens, urban agriculture, farmers markets, and improved access to fresh, locally-sourced foods."
order: 2
...
goals:
  - id: "F-S1"
    ...
    actions:
      ...
      - id: "F-1b"
        text: "Establish a fruit tree and plant giveaway program to encourage urban agriculture and food production on private properties."
      - id: "F-1c"
        text: "Explore incentives to support the development and operation of community gardens."
      - id: "F-1d"
        text: "Convert underutilized lots and rooftops into urban agriculture sites via partnerships."
      - id: "F-1e"
        text: "Prioritize community gardens in underserved neighborhoods."
      - id: "F-1f"
  ...
  - id: "F-S2"
    ...
    actions:
      ...
      - id: "F-2b"
        text: "Evaluate Alhambra Farmers Market for demand/capacity; support mid-week or alternative markets in underserved areas."
      - id: "F-2c"
        text: "Promote local vendors through City communications; educate on environmental benefits of buying local."
      - id: "F-2d"
